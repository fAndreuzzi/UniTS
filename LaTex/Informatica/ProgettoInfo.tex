...
\tikz[overlay,remember picture] {
  ...
  \draw[dashed,->] (11,3.5) -- (6.5,0.05);
  \draw[dashed,->] (10,4.5) -- (4.2,0.05);
  \draw[dashed,->] (10,2.5) -- (12,0.05);
  \draw[dashed,->] (9,3.5) -- (8.4,0.05);
  \draw[dashed,->] (8,2.5) -- (10.2,0.05);
...
\begin{textblock*}{10pt}(100pt,655pt)
  \begin{align*}
    \implies \bm{f(x,y,z,k)} = (\oline{y} \cdot \oline{z} \cdot \oline{k}) + (x \cdot y \cdot \oline{z} \cdot k) + (x \cdot \oline{y} \cdot z \cdot k) + (\oline{x} \cdot y \cdot z) + (\oline{x} \cdot z \cdot \oline{k}) + (y \cdot z \cdot \oline{k})
  \end{align*}
\end{textblock*}
