...
\usepackage{amsmath,amsfonts,amsthm,latexsym,amssymb,amstext,mathabx,epic} % Math packages
...
\begin{tikzpicture}
  ...
  \node[not gate US, draw, rotate=-90] at ($(x0)+(0.5,-1.5)$) (Not0) {};
  \node[not gate US, draw, rotate=-90] at ($(x1)+(0.5,-1.5)$) (Not1) {};
  \node[not gate US, draw, rotate=-90] at ($(x2)+(0.5,-1.5)$) (Not2) {};
  \node[not gate US, draw, rotate=-90] at ($(x3)+(0.5,-1.5)$) (Not3) {};
  ...
  \node[and gate US, draw, logic gate inputs=nnnn] at ($(And0)+(0,-1)$) (And1) {};
  ...
  \node[or gate US, draw, logic gate inputs=nnnnnnnn] at ($(And3)+(3,-0.5)$) (Or0) {};
...
\begin{tikzpicture}
  ...
  \node[or gate US, draw, logic gate inputs=nnnn] at ($(And0)+(0,-1)$) (Or1) {};
  \node[or gate US, draw, logic gate inputs=nnnn] at ($(And1)+(0,-1)$) (Or2) {};
  \node[or gate US, draw, logic gate inputs=nnnn] at ($(And2)+(0,-1)$) (Or3) {};
  \node[or gate US, draw, logic gate inputs=nnnn] at ($(And3)+(0,-1)$) (Or4) {};
  \node[or gate US, draw, logic gate inputs=nnnn] at ($(And4)+(0,-1)$) (Or5) {};
  \node[or gate US, draw, logic gate inputs=nnnn] at ($(And5)+(0,-1)$) (Or6) {};
  \node[or gate US, draw, logic gate inputs=nnnn] at ($(And6)+(0,-1)$) (Or7) {};

  \node[and gate US, draw, logic gate inputs=nnnnnnnn] at ($(Or3)+(3,-0.5)$) (And0) {};
